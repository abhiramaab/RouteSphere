...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CustomerResponse updateCustomer(Long customerId, CreateCustomerRequest request) {
        ...
        CustomerResponse customerResponse = new CustomerResponse();
        customerResponse.setCustomerId(updatedCustomer.getId());
        customerResponse.setCity(updatedCustomer.getCity());
        customerResponse.setCountry(updatedCustomer.getCountry());
        customerResponse.setPincode(updatedCustomer.getPincode());
        customerResponse.setGst(updatedCustomer.getGst());
        customerResponse.setEmail(updatedCustomer.getEmail());
        customerResponse.setAddress(updatedCustomer.getAddress());
        customerResponse.setState(updatedCustomer.getState());
        customerResponse.setContactPerson(updatedCustomer.getContactPerson());
        customerResponse.setCompanyName(updatedCustomer.getCompanyName());
        return customerResponse;
